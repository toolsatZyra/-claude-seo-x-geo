...
Claude SEO is a Tier 4 SEO analysis skill with 32 sub-skills (28 core + 1 orchestrator +
1 framework integration + 2 extension mirrors), 20 sub-agents, and 50 Python execution
scripts.
